 ...
 */
public class Fragment_user_recent_inform_arrange extends Fragment {
    TextView time_view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_user_recent_inform_arrange, container, false);
        ...
        日期 = (TextView)rootView.findViewById(R.id.最近照服時間);
        DB();
        return rootView;
    }
